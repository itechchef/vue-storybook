...
export default {
  ...
  computed: {
    navbarClass() {
      let classes = {
        "text-sm font-medium bg-white border-cool-gray-200 px-2 sm:px-4 py-2.5 w-full h-16 flex flex-nowrap gap-4 items-center justify-between dark:text-cool-gray-300 dark:bg-cool-gray-800": true,
